    ...
    <router-link to="/edit_profile">
      <div class="profile">
        ...
        <div class="profile-center">
          <div class="name">
            <span class="iconfont iconxingbienan"></span>{{getUsersMes.nickname}}
          </div>
    ...
    .then(res=>{
      ...
      if (res.data.message==='获取成功') {
          ...
          if (this.getUsersMes.head_img) {
            this.getUsersMes.head_img = localStorage.getItem('hm40_baseURL')+this.getUsersMes.head_img
          }else{
            this.getUsersMes.head_img = localStorage.getItem('hm40_baseURL') + '/uploads/image/default.png'
          }
      }
    })
    .catch(err=>{
